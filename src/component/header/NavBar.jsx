...
// <<===============================================================================>>
    return(
        <nav className={props.scrollpos > 80 ?"nav-bar active-background":"nav-bar"}>
            {props.screenwidth < 750 && 
            <div className="sidebar-btn">
                <button  className={props.sideBarState === true ? "toggle-dropdownmenu-btn active":"toggle-dropdownmenu-btn"}
                    ...
                    <li>
                        <div className="drop-down">
                            ...
                            <div 
                             ref={dropdownRef} 
                             className={
                              opendropdown ?"drop-down-content active" : "drop-down-content"
                              }>
                                <ul>
                                  <li>
                                    <Link to="/mytasks">
